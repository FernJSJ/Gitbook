...
* **psychedelic**
    * (1) Of or relating to a drug (such as LSD) that produces abnormal and often extreme mental effects such as hallucinations(幻觉)
    * (2) Imitating the effects of psychedelic drugs
    * > In her only psychedelic experience, back in 1970, she had watched with horror as the walls began crawling(爬) with bizarrely colored creatures.
...
* **psychotherapist**
    ...
    * > He's getting medication from a psychiatrist, but it's sessions(会谈) with the psychotherapist that he really values.
    * Many psychologists offer psychological counseling, and psychological counseling can usually be called **psychotherapy**, so many psychologists can be called **psychotherapists**. The most intense form of psychotherapy, called **psychoanalysis**.

## 3. **cept**
* *Latin* **take, seize**

* **capture**
    * which is what **captor** has done to a **captive**, has the same meaning.

* **captivate**
    * once meant literally "capture", but now means only to capture mentally through charm or appeal.

* **reception**
    * (1) The act of receiving
    * (2) A social gathering where guests are formally welcomed
    * > Although the reception of her plan by the board of directors(董事会) was enthusiastic, it was months before anything was done about it.
    * **reception** is the noun form of **receive**

* **intercept**
    * To stop, seize, or interrupt (something or someone) before arrival
    * > The explosives had seen intercepted by police just before being loaded onto the jet.
    * **inter-** means **between**
    * **interceptions** can sometimes be understood as acts of war.
...
* **perceptible**
    ...
    * **per-** means **through**
    * **perceptive** person picks up minor changes, small clues, or hints and shades of meaning that others can't **perceive**, so one person's **perception** —— a tiny sound, a slight change in weather, a different tone of voice —— often won't be perceptible to another
...
* **susceptible**
    ...
    * **sus-** means **up**
    * Susceptible refers to something or someone that "take up" or absorbs like a sponge(海绵)

## 4. **fin**
* *Latin* **end** or **boundary**

* **final**
    * describes last things, and a **finale** or a **finish** is an ending
...
* **confine**
    ...
    * Confine means basically to keep someone or something within border.

* **definitive**
    * (1) Authoritative and final
    * (2) Specifying perfectly or precisely
    * > The team's brilliant research provided a definitive description of the virus and its strange mutation(突变) patterns.
